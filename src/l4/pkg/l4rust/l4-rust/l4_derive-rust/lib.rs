...
fn gen_server_struct(name: proc_macro2::Ident, attrs: Vec<Attribute>,
    ...
    let gen = quote! {
        ...
        impl crate::l4::ipc::types::Dispatch for #name {
            fn dispatch<C: l4::types::CapProvider>(&mut self, tag: crate::l4::ipc::MsgTag,
                        args: &mut ArgAccess<C>)
...
fn gen_client_struct(name: proc_macro2::Ident, attrs: Vec<Attribute>,
                    ...
                    demand: u32)
                -> proc_macro::TokenStream {
    let slot_type: syn::Type = syn::parse(TokenStream::from_str("l4::ipc::Bufferless").unwrap()).unwrap();
    let gen = quote! {
        #(#attrs)*
        #vis struct #name #generics {

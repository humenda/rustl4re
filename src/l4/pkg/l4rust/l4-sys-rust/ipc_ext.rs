...
#[inline]
pub fn msgtag(label: l4_mword_t, words: u32,
...
pub fn msgtag_has_error(t: l4_msgtag_t) -> bool {
    (t.raw & L4_MSGTAG_ERROR as l4_mword_t) != 0
}
...
#[inline]
pub fn msgtag_label(t: l4_msgtag_t) -> l4_mword_t {
...
#[inline]
pub unsafe fn sndfpage_add_u(snd_fpage: l4_fpage_t, snd_base: l4_umword_t,
...
// See `sndfpage_add_u`
#[inline]
pub fn sndfpage_add(snd_fpage: l4_fpage_t, snd_base: l4_umword_t,
        tag: &mut l4_msgtag_t) -> i32 {
    unsafe { // the only unsafe bit here is passing the  UTCB pointer, but l4_utcb() is gauranteed

...
use pc_hal::prelude::*;
use pc_hal_l4::{Vbus, PciDevice, DmaSpace, MappableMemory, Device, Resource, Icu, IoMem};

use l4re::io::IoMemFlags;
...
fn register_msix<E, PD, B, D, ICU, IM>(vbus: &B, nic: &mut PD, icu: ICU) -> Result<(), E>
where
...
fn run<E, D, PD, B, Res, MM, Dma, ICU, IM>(vbus : B) -> Result<(), E> where
    D: pc_hal::traits::Device,
    ...
    IM: pc_hal::traits::IoMem<Error=E>
{
    ...
    register_msix::<_, _, _, _, _, IM>(&vbus, &mut nic, icu)?;

...
//#  define VG_Z_LIBC_SONAME   libucZucZdso // libuc_c.so
#  define VG_Z_LIBC_SONAME NONE // L4Re does not set an SONAME
#else
...
#elif defined(VGO_l4re)
#  define  VG_Z_LIBPTHREAD_SONAME  libpthreadZdso        // libpthread.so
#else
#  error "Unknown platform"
#endif
